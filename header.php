...
<div class="header-bot">
    <div class="container">
        <div class="col-md-3 header-left">
            <h1><a href="index.html"><img src="<?php echo SMARTSHOP_URI ?>assets/images/logo3.jpg"></a></h1>
        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                                ...
                                <ul class="dropdown-menu multi-column columns-3">
                                    <div class="row">
                                        <div class="col-sm-6 multi-gd-img1 multi-gd-text ">
                                            <a href="mens.html"><img src="<?php echo SMARTSHOP_URI ?>assets/images/woo1.jpg" alt=" "/></a>
                                        </div>
                                ...
                                <ul class="dropdown-menu multi-column columns-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 multi-gd-img multi-gd-text ">
                                            <a href="womens.html"><img src="<?php echo SMARTSHOP_URI ?>assets/images/woo.jpg" alt=" "/></a>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </ul>
                            ...
                            <li class=" menu__item menu__item--current"><a class="menu__link" href="codes.html">Short
                                    Codes</a></li>
